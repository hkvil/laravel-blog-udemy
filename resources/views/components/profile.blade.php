<x-layout :title="$title">
        <div class="container py-md-5 container--narrow">
            ...
            <div class="profile-nav nav nav-tabs pt-2 mb-4">
                ...
                <a href="/profile/{{$sharedData['username']}}/follower" class="profile-nav-link nav-item nav-link {{Request::segment(3) == "follower" ? "active" : ""}}" >Followers: {{$sharedData['followerCount']}}</a>
